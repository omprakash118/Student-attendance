...
studentList.innerHTML = `
    <div class="w-full max-w-4xl rounded-lg bg-[#0d1b2a] p-6 shadow-md">
  <div class="mb-4 flex items-center justify-between">
    <div class="space-x-2">
      <button class="cursor-pointer rounded-md border border-[#415a77] px-4 py-2 text-[#8e9baa] transition duration-300 hover:bg-[#778da944] hover:text-[#e0e1dd] active:scale-95 active:bg-[#415a77]">Add Student</button>
      <button class="cursor-pointer rounded-md border border-[#415a77] px-4 py-2 text-[#8e9baa] transition duration-300 hover:bg-[#778da944] hover:text-[#e0e1dd] active:scale-95 active:bg-[#415a77]">View Archived</button>
    </div>
