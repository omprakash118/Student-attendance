...
notice.innerHTML = `
    <div class="mx-auto max-w-4xl">
        ...
        <div class="flex justify-between items-center text-center m-3 p-3 bg-[#1b263b] rounded-2xl  ">
            <h2 class=" text-2xl pl-6 font-bold text-[#8e9baa]">Notices</h2>
            <button 
                class="w-10 h-8 text-center rounded-2xl nav-link text-[#8e9baa] hover:bg-[#778da9a3] bg-[#778da944] active:bg-[#415a77] border cursor-pointer  transition duration-300 active:scale-95 border-[#415a77]   hover:text-[#e0e1dd]" data-target = "notice_form">
        ...
        <div class="space-y-4 p-3">
            <!-- Notice Card -->
            <div class="rounded-lg border border-[#8e9baa] bg-[#1b263b] p-4 ">
